...
const dbConfig = require("C:/VSC/BED-Practicals/Week04/books-api-mvc-db/dbConfig.js");
...
class User {
    ...
    static async updateUser(id, updatedUser) {
        ...
        const request = connection.request();
        request.input("id", id);
        request.input("title", user.username || null); // Handle optional fields
        request.input("author", user.email || null);
